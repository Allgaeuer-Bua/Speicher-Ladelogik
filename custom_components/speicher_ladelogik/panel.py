...
PANEL_ENTITIES: Final = {
    ...
    "mindestreserve_venus_a": ("number", "mindestreserve_venus_a"),
    "mindestreserve_venus_d": ("number", "mindestreserve_venus_d"),
    "mindestreserve_venus_e": ("number", "mindestreserve_venus_e"),
