...
CONTROL_DEFAULTS: dict[str, Any] = {
    ...
    "maximale_ladeleistung_a_w": 1500.0,
    "maximale_ladeleistung_e_w": 2500.0,
    "maximale_ladeleistung_d_w": 2500.0,
    "maximale_entladeleistung_a_w": 1500.0,
    "maximale_entladeleistung_e_w": 2500.0,
    "maximale_entladeleistung_d_w": 2500.0,
    "nennkapazitaet_a_kwh": 4.16,
    "nennkapazitaet_e_kwh": 5.12,
    "nennkapazitaet_d_kwh": 5.12,
    "mindestreserve": 2.0,
    "mindestreserve_a_kwh": 1.0,
    "mindestreserve_d_kwh": 1.0,
    "mindestreserve_e_kwh": 1.0,
    "fruehes_ladeziel_a_soc": 0.0,
    "fruehes_ladeziel_d_soc": 0.0,
    "fruehes_ladeziel_e_soc": 0.0,
...
HELPER_TO_CONTROL: dict[str, str] = {
    ...
    "input_number.speicher_ladelogik_mindestreserve_a_kwh": "mindestreserve_a_kwh",
    "input_number.speicher_ladelogik_mindestreserve_d_kwh": "mindestreserve_d_kwh",
    "input_number.speicher_ladelogik_mindestreserve_e_kwh": "mindestreserve_e_kwh",
    "input_number.speicher_ladelogik_fruehes_ladeziel_a_soc": "fruehes_ladeziel_a_soc",
    "input_number.speicher_ladelogik_fruehes_ladeziel_d_soc": "fruehes_ladeziel_d_soc",
    "input_number.speicher_ladelogik_fruehes_ladeziel_e_soc": "fruehes_ladeziel_e_soc",
    ...
    "input_number.speicher_ladelogik_mittag_vorlauf_h": "mittag_vorlauf_h",
    "input_number.speicher_ladelogik_mittag_nachlauf_h": "mittag_nachlauf_h",
    ...
    "input_number.speicher_ladelogik_maximale_ladeleistung_a_w": "maximale_ladeleistung_a_w",
    "input_number.speicher_ladelogik_maximale_ladeleistung_e_w": "maximale_ladeleistung_e_w",
    "input_number.speicher_ladelogik_maximale_ladeleistung_d_w": "maximale_ladeleistung_d_w",
    "input_number.speicher_ladelogik_maximale_entladeleistung_a_w": "maximale_entladeleistung_a_w",
    "input_number.speicher_ladelogik_maximale_entladeleistung_e_w": "maximale_entladeleistung_e_w",
    "input_number.speicher_ladelogik_maximale_entladeleistung_d_w": "maximale_entladeleistung_d_w",
