...
NUMBERS = (
    ...
    SpeicherNumberDescription(key="mindestreserve_venus_a", name="Mindestreserve Venus A", control_key="mindestreserve_a_kwh", minimum=0, maximum=20, step=0.1, native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR),
    SpeicherNumberDescription(key="mindestreserve_venus_d", name="Mindestreserve Venus D", control_key="mindestreserve_d_kwh", minimum=0, maximum=20, step=0.1, native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR),
    SpeicherNumberDescription(key="mindestreserve_venus_e", name="Mindestreserve Venus E", control_key="mindestreserve_e_kwh", minimum=0, maximum=20, step=0.1, native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR),
